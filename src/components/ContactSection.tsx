          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="rounded-3xl bg-[#FAF7F2] border border-[#DFCBB0] p-8 shadow-lg space-y-6">
              ...
              <div className="flex items-start gap-4 pb-5 border-b border-[#F0E3D3]">
                <div className="w-11 h-11 rounded-2xl bg-[#F4E8D7] flex items-center justify-center text-[#9C7537] shrink-0 shadow-xs">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-xs text-[#9C7537] hover:text-[#7A5822] font-semibold mt-2 underline"
                  >
              ...
              <div className="flex items-start gap-4 pb-5 border-b border-[#F0E3D3]">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-lg font-display-luxury font-bold text-[#2C2420] hover:text-[#8C6D37] transition-colors mt-0.5 block"
                  >
              ...
              <div className="flex items-start gap-4 pb-5 border-b border-[#F0E3D3]">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-sm font-medium text-[#2C2420] hover:text-[#8C6D37] transition-colors mt-0.5 block break-all"
                  >
                    {BUSINESS_INFO.email}
                  </a>
                  <p className="text-xs text-[#615349] mt-0.5">
            ...
            <button
              ...
              className="w-full py-4 rounded-2xl bg-gradient-to-r from-[#B88B43] to-[#C99F53] text-white font-semibold text-xs uppercase tracking-[0.2em] shadow-md hover:shadow-lg flex items-center justify-center gap-2 cursor-pointer transition-all"
              id="contact-book-btn"
            >
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="rounded-3xl bg-[#FAF7F2] border border-[#DFCBB0] p-8 shadow-lg space-y-4">
              ...
              <div className="space-y-3 text-xs sm:text-sm text-[#54483F] leading-relaxed font-light">
                <div className="p-3.5 rounded-xl bg-[#F7F1E7] border-l-3 border-[#B88B43]">
                  <strong className="text-[#362B25] font-semibold block mb-0.5">
                    ☀️ Spray Tan Preparation (R380)
                  </strong>
              ...
              <div className="rounded-2xl overflow-hidden border border-[#D9C4A1] relative h-64 bg-[#EADDCB]">
                ...
                <div className="absolute bottom-3 left-3 right-3 p-3 rounded-xl bg-[#FAF7F2]/95 backdrop-blur-sm border border-[#D8C09A] flex items-center justify-between shadow-md">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-3 py-1.5 rounded-full bg-[#B88B43] hover:bg-[#A37834] text-white text-[10px] font-semibold uppercase tracking-wider transition-colors"
                  >
                    Directions
                  </a>
                </div>
